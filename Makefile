...
INSTALL_DIR	=	/usr/share/my_deamons
...
cflags.common	:=	-W -Wall -Wextra -pedantic -D_GNU_SOURCE -I./include/ -I./lib/include/
cflags.debug	:=	-g3  -save-temps=obj
cflags.release	:=
cflags.tests	:=

ldflags.common	:=	-L./lib/output -llog
ldflags.debug	:=
ldflags.release	:=
